...
class TestAccountsRoutesWithoutAuthentication(TestCase):
    ...
    def test_wrong_data_user_creation_400(self):
        ...
        response = self.client.post(
            "/api/accounts/", self.instructor_wrong_data, format="json"
        )
        output = response.json()
    ...
    def test_login_with_invalid_credentials_401(self):
        ...
        self.client.post("/api/accounts/", self.instructor_data, format="json")
        response = self.client.post(
            "/api/login/", self.instructor_login_wrong_data, format="json"
        )
    ...
    def test_login_with_wrong_fields_400(self):
        ...
        self.client.post("/api/accounts/", self.instructor_data, format="json")
        response = self.client.post(
            "/api/login/", self.instructor_login_wrong_field, format="json"
        )
        output = response.json()
    ...
    def test_list_users_by_student_403(self):
        ...
        token = self.client.post(
            "/api/login/", self.student_login_data, format="json"
        ).json()["token"]
        self.client.credentials(HTTP_AUTHORIZATION="Token " + token)
...
class TestCoursesCreation(TransactionTestCase):
    ...
    def test_course_creation_wrong_data_400(self):
        ...
        response = self.client.post(
            "/api/courses/", self.course_data_wrong, format="json"
        )
        output = response.json()
...
class TestCoursesUpdate(TransactionTestCase):
    ...
    def test_update_course_by_instructor_200(self):
        ...
        response = self.client.patch(
            f"/api/courses/{uuid}/", self.course_data_update, format="json"
        )
        output = response.json()
    ...
    def test_update_course_by_student_403(self):
        ...
        self.assertNotEqual(
            response_course.json()["name"], str(self.course_data_update["name"])
        )
    ...
    def test_update_invalid_course_404(self):
        ...
        response_course = self.client.get(
            f"/api/courses/{self.course_id}/", format="json"
        )
...
class TestCoursesRegister(TransactionTestCase):
    def setUp(self):
        ...
        self.instructor_id = self.client.post(
            "/api/accounts/", self.instructor_data, format="json"
        ).json()["uuid"]
        ...
        self.student_id = self.client.post(
            "/api/accounts/", self.student_data, format="json"
        ).json()["uuid"]
        ...
        self.student_id_2 = self.client.post(
            "/api/accounts/", self.student_data_2, format="json"
        ).json()["uuid"]
    ...
    def test_register_instructor_course_by_instructor_200(self):
        ...
        body = {"instructor_id": self.instructor_id}

        # Tentando registrar o instructor no curso já criado
        response = self.client.put(
            f"/api/courses/{course_id}/registrations/instructor/", body, format="json"
        )
        output = response.json()
        ...
        course_response = self.client.get(
            f"/api/courses/{course_id}/", format="json"
        ).json()
        ...
        course_id_2 = self.client.post(
            "/api/courses/", self.course_data_update, format="json"
        ).json()["uuid"]

        # Tentando registrar o instructor no segundo curso
        response = self.client.put(
            f"/api/courses/{course_id_2}/registrations/instructor/", body, format="json"
        )
        output = response.json()
        ...
        instructor_2_uuid = self.client.post(
            "/api/accounts/", self.instructor_data_2, format="json"
        ).json()["uuid"]

        body_2 = {"instructor_id": instructor_2_uuid}

        # Tentando registrar o instructor_2 no segundo curso
        response = self.client.put(
            f"/api/courses/{course_id_2}/registrations/instructor/",
            body_2,
            format="json",
        )
        output = response.json()
    ...
    def test_register_instructor_course_with_student_id_422(self):
        ...
        body = {"instructor_id": self.student_id}
        ...
        self.assertEqual(response.status_code, 422)
        self.assertEqual(
            output, {"message": "Instructor id does not belong to an admin"}
        )
    ...
    def test_register_instructor_course_with_invalid_id_404(self):
        ...
        body = {"instructor_id": "49946481-3b89-424c-9581-80ffdf74a23c"}
    ...
    def test_register_instructor_course_with_wrong_field_400(self):
        ...
        body = {"instructor": self.instructor_id}
    ...
    def test_register_students_course_by_intructor_200(self):
        ...
        body = {"students_id": [self.student_id, self.student_id_2]}

        # Tentando registrar os students
        response = self.client.put(
            f"/api/courses/{course_id}/registrations/students/", body, format="json"
        )
        output = response.json()
        ...
        course_2_id = self.client.post(
            "/api/courses/", self.course_data_update, format="json"
        ).json()["uuid"]

        # Tentando registrar os students no segundo curso
        response = self.client.put(
            f"/api/courses/{course_2_id}/registrations/students/", body, format="json"
        )
        output = response.json()

        # Checando se os dois students estão no segundo curso
        course_response_2 = self.client.get(
            f"/api/courses/{course_2_id}/", format="json"
        ).json()
    ...
    def test_register_students_course_by_student_403(self):
        ...
        body = {"students_id": [self.student_id]}
    ...
    def test_register_students_course_with_invalid_student_id_404(self):
        ...
        body = {"students_id": ["d0495ae5-7b7c-42b4-af28-7d386f2aaca7"]}
    ...
    def test_register_students_course_with_instructor_id_422(self):
        ...
        body = {"students_id": [self.instructor_id]}
        ...
        self.assertEqual(response.status_code, 422)
        self.assertEqual(
            output, {"message": "Some student id belongs to an Instructor"}
        )
...
class TestAddress(TestCase):
    ...
    def test_address_creation_already_exists_200(self):
        ...
        token = self.client.post(
            "/api/login/", self.student_login_data_2, format="json"
        ).json()["token"]
        self.client.credentials(HTTP_AUTHORIZATION="Token " + token)
    ...
    def test_address_creation_wrong_data_400(self):
        ...
        response = self.client.put(
            "/api/address/", self.address_data_wrong, format="json"
        )
        output = response.json()
